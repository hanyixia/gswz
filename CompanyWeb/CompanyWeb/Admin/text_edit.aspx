<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="text_edit.aspx.cs" Inherits="CompanyWeb.Admin.text_edit" %>
    ...
    <form id="Form1" method="post" runat="server" onsubmit="return check()">
        <div class="x-body layui-anim layui-anim-up">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <asp:TextBox ID="textdesc" runat="server" class="layui-input" required="" autocomplete="off"></asp:TextBox>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <asp:TextBox ID="textauthor" runat="server" class="layui-input" required="" autocomplete="off"></asp:TextBox>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    ...
                    <input id="lj" type="hidden" runat="server" />
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">
...
<script type="text/javascript">
    $(function () {// 初始化内容     
        var proinfo = document.getElementById("txtEditorContents").value
