...
{
    public partial class com_category_list : System.Web.UI.Page
    {
        public int count = 0;
        ...
        protected void delete_Fun(int ID)
        {
            ...
            if (aa)
            {
                Response.Write("<script>alert('删除成功！');window.location.href='com_category_list.aspx';</script>");
            }
            else
            {
                Response.Write("<script>alert('删除失败！');window.location.href='com_category_list.aspx';</script>");
            }
        }
        #endregion
